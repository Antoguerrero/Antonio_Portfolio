...
export default function Administracion() {
    ...
    return (
        ...
        <div>
            ...
            <div className="container">
                <h1 className='soy dos'>EXPERIENCIA LABORAL ADMINISTRACIÓN Y FINANZAS</h1>
            </div>
            <p className='text'>
                <div className="etiqueta">
                    - Agente comercial y administrativo - Cebollas Quintanar
                    <br />
                    <sub>Busqueda activa de clientes, apoyo administrativo</sub>
                </div>
            </p>
        </div>
